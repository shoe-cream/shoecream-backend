...
public interface OrderItemQueryRepositoryCustom {
    //납기일이 해당 기간 내에 해당하는 주문 리스트 + 영업사원
    List<OrderItems> findByOrderHeadersRequestDateBetween(String employeeId, LocalDateTime startDateTime, LocalDateTime endDateTime);
    ...
    BigDecimal findTotalOrderPriceByItemCdAndOrderDateBetween(String itemCd, String employeeId, LocalDateTime startDateTime, LocalDateTime endDateTime);
